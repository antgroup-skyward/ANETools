...
int main(int argc, char **argv) {
    ...
    printf("network : %s\n", ipath);
    ret = espresso_plan_add_network(plan, ipath, 0x10020LL, vals);
    printf("espresso_plan_add_network ret %d\n", ret);
    ...
    printf("espresso_plan_build ret %d\n", ret);
    strncpy(opath, argv[2], sizeof(opath) - 1);
    printf("out path : %s\n", opath);
    char *opath1 = opath;
    ret = espresso_dump_ir(plan, &opath1);
    printf("espresso_dump_ir ret %d\n", ret);
